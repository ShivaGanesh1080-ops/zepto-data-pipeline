...
# Create the python script that will generate and run the notebooks
script_content = r'''
...
with open(r'C:\Users\DELL\.gemini\antigravity\scratch\analytics\build_notebooks.py', 'w', encoding='utf-8') as f:
